...
\section{Skills}
\createskills{
    \createskill{Programming Languages}{Python \cpshalf React \cpshalf Go \cpshalf C++ \cpshalf C\# \cpshalf TypeScript \cpshalf Java \cpshalf Bash \cpshalf SQL \cpshalf Android \cpshalf Lua},
    ...
    \createskill{Tools \& Engines}{IA \& LLM \cpshalf Unity \cpshalf UE5 \cpshalf Figma \cpshalf Visual Studio \cpshalf Confluence \cpshalf Jira \cpshalf Linear \cpshalf Datadog},
    \createskill{Practices}{CI/CD \cpshalf QA Automation \cpshalf Product Management \cpshalf Team Leadership \cpshalf Agile/Scrum}
}
\vspace{-3mm}
